...
export default function MarkersLayer({
  ...
  const selectedMarkerSet = new Set(selectedMarkerIds);
  ...
  useEffect(() => {
    ...
    const markerNodes = markersRef.current;
    ...
    <Layer>
      ...
      {imageStatus === "loaded" &&
        markers
          ...
          .map((marker, index) => {
            const isSelected = selectedMarkerSet.has(marker.id);
            ...
            <Circle
              ...
              stroke={isSelected ? "#F59E0B" : strokeColor[marker.type] || "#0D49BF"}
